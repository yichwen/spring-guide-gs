package io.bamu.spring.cloud.loadbalancer.config;
...
public class SayHelloConfiguration {
    ...
    ServiceInstanceListSupplier serviceInstanceListSupplier() {
        return new SameInstancePreferenceServiceInstanceListSupplier(new DemoServiceInstanceListSuppler("say-hello"));
    }
